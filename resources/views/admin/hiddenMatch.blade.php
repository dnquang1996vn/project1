                ...
                <div class="row mt">
                    <div class="col-lg-12">
                        <div class="content-panel">
                            ...
                            <h4><i class="fa fa-angle-right"></i>total hidden matches: </h4>
                            <table class="table table-hover table-striped table-advanced table-bordered"
                                ...
                                <tbody>
                                   <tr>
                                        ...
                                        <td class="col-lg-1" class="numeric">manchester</td>
                                        <td class="col-lg-1" class="numeric">real</td>
                                        <td class="col-lg-2" class="numeric">9:30:20 12.2.2</td>
                                        <td class="col-lg-2" class="numeric">9:30:20 12.2.2</td>
                                        <td class="col-lg-2" class="pull-center">9:30:20 12.2.2<br></td>
                                        <td class="col-lg-2" class="pull-left">la liga</td>
                                         <td>
                                      <button class="btn btn-success btn-xs">public<i class="fa fa-check"></i></button>
